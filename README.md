...
Run `ng serve angular8app` for a dev server. Navigate to http://localhost:4200/. The app will automatically reload if you change any of the source files.
...
Run `ng e2e angular8app` to execute the end-to-end tests via [Cypress](https://www.cypress.io).
